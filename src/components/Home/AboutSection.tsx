				...
				>
					...
					<Box sx={{ maxWidth: '550px', p: 2 }}>
						...
						<Typography variant='body2'>
							GetBack is a community-driven platform designed to help people report and reclaim lost items. Our mission
							is to connect finders with owners, making it easier for lost belongings to be reunited with their rightful
